...
public partial class Door_script : Node2D
{
	...
	public override void _Process(double delta)
	{
		...
		if (objects_inside == 0)
		{// Checks if any enemies are behind the doors and either open or closes the doors
	...
	{ //adds an enemy to the behind door count
	...
	{// removes an enemy from the behind the door count
		if (area.Name == "Enemy_hitbox_container")
		{
			objects_inside -= 1;
		}
